...
from  events.views import home,event_create,create_category,show_Detail,user_dashboard,event_delete,event_update,all_categories,category_update,category_delete,search_events,manager_dashboard,dashboard,EventCreate,UserDashboard,DeleteEvent,CategoriesView,DeleteCategory
urlpatterns = [
    # path('manager-dashboard/', manager_dashboard,name='manager'),
    path('manager-dashboard/', UserDashboard.as_view(),name='manager'),
    ...
    path("delete-event/<int:id>/",DeleteEvent.as_view(),name ='delete'),
    path("",home, name="home"),
    ...
    path("categories/",CategoriesView.as_view(), name="list-category"),
    ...
    path("categories/delete/<int:id>/",DeleteCategory.as_view(), name="category_delete"),
