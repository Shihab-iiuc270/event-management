...
from  events.views import home,event_create,create_category,show_Detail,user_dashboard,event_delete,event_update,create_participnat,all_participant,participant_delete,participant_update,all_categories,category_update,category_delete,search_events
urlpatterns = [
